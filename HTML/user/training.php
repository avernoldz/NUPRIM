...
<body>
    ...
    <div class="main">
        ...
        <div>
            ...
            <form action="action/training.php" method="POST" id="edit-training">
                <div class="row bg column-gap-3 items-end">
                    ...
                    $query2 = "SELECT * FROM training WHERE userid = '$userid' ORDER BY dateStart DESC";
                    ...
                    ?>
                            <div class="col-12 mt-3 flex flex-wrap justify-between items-center">
                                <h2 class="text-[18px] font-bold"><?php echo emptyData("name", $row2) ?></h2>
                                <div class="col-1 mb-[8px] text-center">
                                    <a href="action/training.php?trainingid=<?php echo $row2["trainingid"] ?>&userid=<?php echo $userid ?>&delete" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
                                </div>
                            </div>
        ...
        <form action="action/training.php" method="POST" id="training" enctype="multipart/form-data">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Add Training</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row column-gap-3">
                                <div class="col-12 mb-4">
                                    <label for="name" class="form-label">Training/Seminar Name</label>
                                ...
                                <!-- <div class="col mb-4">
                                    <label for="authno" class="form-label">Authority Number</label>
                                    <input type="text" id="authno" class="form-control" name="authno">
                                </div>

                                <div class="col mb-4">
                                    <label for="authdate" class="form-label">Authority Date</label>
                                    <input type="date" id="authdate" class="form-control" name="authdate">
                                </div> -->
