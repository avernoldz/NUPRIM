    ...
    <div class="main">
        ...
        <form action="action/address.php" method="POST" id="forms">
            <div class="row bg column-gap-3 items-end">
                ...
                $query2 = "SELECT * FROM detail WHERE userid = '$userid' ORDER BY dateStart DESC";
                ...
                ?>
                        <div class="col-12 mt-3 flex flex-wrap justify-between items-center">
                            <h2 class="text-[18px] font-bold"><?php echo $row2['orderType'] ?>
                                <?php
                        ...
                        <div class="row p-3 column-gap-3 w-100">
                            <div class="col-12 mb-2">
                                ...
                                <input type="text" id="office" class="form-control" name="office" value="<?php echo emptyData("office", $row2) ?>" disabled>
                            </div>
